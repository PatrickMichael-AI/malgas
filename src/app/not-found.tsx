...
export default function NotFound() {
  return (
    <section className="story-shell motion-enter bg-card px-6 py-10 sm:px-8 sm:py-12">
      ...
      <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/92 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-foreground/76 shadow-paper">
          ...
          <p className="mt-4 max-w-xl text-base leading-8 text-foreground/86 sm:text-lg">
        ...
        <aside className="postcard-panel motion-enter motion-delay-2 bg-background/88 px-5 py-5">
